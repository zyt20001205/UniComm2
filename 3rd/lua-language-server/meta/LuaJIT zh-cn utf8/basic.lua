...
---* `"setpause"`：将 arg 设置为收集器间歇率的新值（参见 [§2.10](command:extension.lua.doc?["en-us/51/manual.html/2.10"])）。返回间歇率的先前值。
---* `"setstepmul"`：将 arg 设置为收集器步进倍率的新值（参见 [§2.10](command:extension.lua.doc?["en-us/51/manual.html/2.10"])）。返回步进倍率的先前值。
---
---
---[查看文档](command:extension.lua.doc?["en-us/51/manual.html/pdf-collectgarbage51"])
---
