...
IndicatorSettingScript::IndicatorSettingScript(QWidget *parent)
    ...
    // diagnostics
    {
        ...
        auto *indicatorErrorStyleLabel = new QLabel(tr("Error Indicator Style")); // NOLINT
        ...
        auto *indicatorErrorColorLabel = new QLabel(tr("Error Indicator Color")); // NOLINT
        ...
        auto *indicatorWarningStyleLabel = new QLabel(tr("Warning Indicator Style")); // NOLINT
        ...
        auto *indicatorWarningColorLabel = new QLabel(tr("Warning Indicator Color")); // NOLINT
        ...
        auto *indicatorInfoStyleLabel = new QLabel(tr("Info Indicator Style")); // NOLINT
        ...
        auto *indicatorInfoColorLabel = new QLabel(tr("Info Indicator Color")); // NOLINT
        ...
        auto *indicatorHintStyleLabel = new QLabel(tr("Hint Indicator Style")); // NOLINT
        ...
        auto *indicatorHintColorLabel = new QLabel(tr("Hint Indicator Color")); // NOLINT
...
void IndicatorSettingScript::settingImport(const QJsonObject &indicatorConfigScript) const {
    ...
    m_diagnosticPreviewEditor->setText(
